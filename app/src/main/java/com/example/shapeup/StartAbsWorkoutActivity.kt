...
class StartAbsWorkoutActivity : AppCompatActivity() {

    private var exerciseTitles = arrayOf("Leg Raises", "Bicycle Crunches", "Dead Bugarms", "Cross Sit Ups",
        "OverHead Crunches", "Esquire","Long Plank")

    private var exerciseDetail = arrayOf(
        "Do 10 Legraises in 50 sec",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_start_abs_workout)
